...
import com.example.vanphu.mymoney.tab.Tab_Month_Total;
import com.example.vanphu.mymoney.tab.Tab_Month_to_Month_Total;
import com.example.vanphu.mymoney.tab.Tab_Week;
import com.example.vanphu.mymoney.tab.Tab_Week_Total;
import com.example.vanphu.mymoney.tab.Tab_Week_item;
import com.example.vanphu.mymoney.tab.Tab_Week_item_Total;
...
public class TotalSpendColletedActivity extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_spend_colleted);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_total_spend_colleted, menu);
        return true;
    }
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                pieChart.setOnChartValueSelectedListener(TotalSpendColletedActivity.this);
                            } catch (Exception e) {
                                Toast.makeText(TotalSpendColletedActivity.this, "Lỗi" + e, Toast.LENGTH_LONG).show();
                            }
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TotalSpendColletedActivity.this, "Lỗi " + error.toString(), Toast.LENGTH_LONG).show();
//                        error();
                    }
                }
        );
    ...
    public void onValueSelected(Entry e, Highlight h) {
        try {
            ...
            Toast.makeText(TotalSpendColletedActivity.this, "Giá Chi Tiêu: " + e.getY() + " " + SpendController.sKeyMoney, Toast.LENGTH_LONG).show();
        } catch (Exception e1) {
            Toast.makeText(TotalSpendColletedActivity.this, "Lỗi" + e.toString().trim(), Toast.LENGTH_LONG).show();
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_total_spend_colleted, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new Tab_Day_Total();
                case 1:
                    return new Tab_Month_Total();
                case 2:
                    return new Tab_Month_to_Month_Total();
                case 3:
